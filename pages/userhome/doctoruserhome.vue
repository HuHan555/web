		...
		<view class="main">
			...
			<view class="user-inf">
				...
				<view class="introduct">
					<view >BP:{{this.data.bp}}</view>
					<view >BPM:{{this.data.bpm}}</view>
					<view >GLU:{{this.data.glu}}</view>
					<view >TCHO:{{this.data.tcho}}</view>
					<view >TG:{{this.data.tg}}</view>
					<view >acid:{{this.data.acid}}</view>
					<view >LDL:{{this.data.ldl}}</view>
				</view>
			</view>
		</view>
	</view>
	...
	export default {
		...
		methods: {
					...
					success:(res)=> {
						...
						uni.uploadFile({
							...
							success: (uploadFileRes) => {
								that.img=that.ip+uploadFileRes.data
			...
			gettodayrecord:function(){
				let that=this
				uni.request({
					url:that.ip+'record/gettodayrecord',
					data:{
